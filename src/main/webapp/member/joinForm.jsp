		...
		<table style="width: 600; margin-left: auto; margin-right: auto"
			...
			<tr>
				...
				<td><input type="checkbox" name="hobby" value="computer">컴퓨터</input>
					<input type="checkbox" name="hobby" value="internet">인터넷</input> <input
					type="checkbox" name="hobby" value="travel">여행</input> <input
					type="checkbox" name="hobby" value="movie">영화감상</input> <input
					type="checkbox" name="hobby" value="music">음악감상</input></td>
			</tr>
			<tr>
